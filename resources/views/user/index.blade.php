            ...
            <div class="col-xl-8 col-md-8 col-sm-12 mr-auto">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="my-4">
                        <h6 class="heading-small text-muted mb-4" id="password-section">Informasi Pengiriman</h6>
                        <div class="pl-lg-4">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="text" placeholder="Alamat Pengiriman"
                                                ...
                                                value="{{ auth()->user()->userInfo->address ?? '' }}" required>
                                            @error('address')
                                        ...
                                        <div class="form-group">
                                            <input type="text" placeholder="No.Telp"
                                                ...
                                                value="{{ auth()->user()->userInfo->phone ?? '' }}" required>
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                        ...
                        <hr class="my-4">
                        <h6 class="heading-small text-muted mb-4" id="password-section">Ganti Password</h6>
                        <div class="pl-lg-4">
                            <form action="{{ route('account.changePassword') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="password" placeholder="Sandi saat ini *"
