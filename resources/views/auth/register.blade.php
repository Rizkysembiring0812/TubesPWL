...
@section('content')
    <div class="container py-5">
        <div class="d-flex align-items-center justify-content-between">
            <h3>Daftarkan Akun Bazmi Sekarang!</h3>
            <div class="small"><span>Sudah Punya Akun? <a href="{{ route('login') }}">Masuk</a> disini!.</span>
            </div>
        </div>
        <div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        {{-- <div class="form-check">
                            ...
                            <label class="form-check-label" for="receiveOffers">I want to receive exclusive offers and
                                promotions from Mart.</label>
                        </div> --}}

                        <button type="submit" class="btn btn-orange btn-block">Daftar</button>
                        {{-- <div class="mb-3">
                            <small>By clicking “SIGN UP”, I agree to Mart's
                                <a href="#" target="_blank">Terms of Use</a> and <a href="#" target="_blank">Privacy
                                    Policy</a>
                            </small>
                        </div>
