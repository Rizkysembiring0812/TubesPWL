                        ...
                        <div class="my-4">
                            <div class="row">
                                <div class="col-sm-6 col-md-3">
                                    <img src="{{ asset($product->productImage->first()->thumbnail) }}"
                                        class="img-fluid" alt="">
                                </div>
                                <div class="col-sm-12 col-md-9">
                                    <h4>{{ $product->title }}</h4>
                                    @if ($product->onSale)
                                        <p>Price : <span>Rp.{{ number_format($product->price) }}</span></p>
                                        <p>Sale Price : Rp.{{ number_format($product->sale_price) }} </p>
                                    @else
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Price" name="flash_price"
                                            value="{{ $flashSale->flash_price }}" class="form-control">
                                    </div>
